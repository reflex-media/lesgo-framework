...
declare const _default: {
    ...
    query: (tableAlias: string, keyConditionExpression: string, expressionAttributeValues: Record<string, string>, opts?: import("../../services/DynamoDbService/query").QueryOptions | undefined, clientOpts?: import("../../types/aws").ClientOptions | undefined) => Promise<Record<string, any>[]>;
