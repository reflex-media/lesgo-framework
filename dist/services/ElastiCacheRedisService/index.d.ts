...
declare const _default: {
    getElastiCacheRedisClient: (clientOpts?: import("./getElastiCacheRedisClient").ElastiCacheRedisClientOptions | undefined) => Promise<import("@redis/client").RedisClientType<{
        graph: {
    ...
    setRedisCache: (key: string, value: any, opts?: import("./setRedisCache").SetRedisCacheOptions | undefined, clientOpts?: import("../../types/aws").ClientOptions | undefined) => Promise<string | null>;
