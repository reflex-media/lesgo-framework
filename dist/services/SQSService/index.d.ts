...
declare const _default: {
    ...
    dispatch: (payload: Record<any, any>, queue: string | import("./getQueueUrl").Queue, opts?: import("./dispatch").DispatchOptions | undefined, clientOpts?: import("../../types/aws").ClientOptions | undefined) => Promise<import("@aws-sdk/client-sqs").SendMessageCommandOutput>;
