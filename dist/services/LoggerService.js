...
class LoggerService {
    constructor(opts = {}) {
        ...
        const options = Object.assign(Object.assign({}, defaultOptions), { logger: opts.logger || defaultOptions.logger, meta: Object.assign(Object.assign({}, defaultOptions.meta), (opts.defaultMeta || {})), transports: opts.transports || [] });
    ...
    getTransportByName(transportName) {
        return this.transports.find(transport => transport.logType === transportName);
    }
}
