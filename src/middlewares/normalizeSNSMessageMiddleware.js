...
const FILE = 'Lesgo/middlewares/normalizeSNSMessageMiddleware';
...
const normalizeSNSMessageMiddleware /* istanbul ignore next */ = opts => {
  return {
    before: (handler, next) => {
...
export default normalizeSNSMessageMiddleware;
